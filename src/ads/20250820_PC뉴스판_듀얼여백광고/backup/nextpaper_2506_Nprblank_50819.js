(function () {
    ...
    var _actionCode = `
                ...
                if (w < N) { return; } 
                googletag.defineSlot('/21682743634,22664242840/S003/nate_pc_ap_bottom03_120x600', [120,600], 'S003_nate_pc_ap_bottom03_120x600').addService(googletag.pubads().set('page_url', '//nate.com')); 
                googletag.pubads().enableSingleRequest();
                googletag.enableServices();
                googletag.display('S003_nate_pc_ap_bottom03_120x600');
                });
            `;
    _script.innerHTML = _actionCode;
    _lib.src = 'https://securepubads.g.doubleclick.net/tag/js/gpt.js';
    _lib.async = true;
    _div.setAttribute('id', 'S003_nate_pc_ap_bottom03_120x600');
