(function () {
        ...
        var alt_text    = '광고';
        var adsEl       = '<a href="' + click_path + '" style="display:block; text-align:center; height:' + ad_height + 'px;background:' + bgcolor + '" target="_blank" ><img alt="' + alt_text + '" src="' + img_path + '" width="320" height="'+ ad_height +'" border="0"></a>';
        var ad_id       = '.pageAd_top'; // 모바일 뉴스 리스트 상단배너 이미지 광고

        if( self === top ) {
            var target = document.querySelector(ad_id);
