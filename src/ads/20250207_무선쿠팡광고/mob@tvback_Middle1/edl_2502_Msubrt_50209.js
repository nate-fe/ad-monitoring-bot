// 애즈명 : edl_2502_Msubrt_50209
// 광고코드 : <script src="https://api.ootoo.co.kr/cou/api_reco.php?code=2main300x250&adid=&type=js&click_log=&click_type="></script>
; (function () {
    var adHeight = 250;
    ...
    ; (function () {
        document.write('<script src="https://api.ootoo.co.kr/cou/api_reco.php?code=2main300x250&adid=' + _adid + '&type=js&click_log=&click_type="></script>')
    })()
})()
