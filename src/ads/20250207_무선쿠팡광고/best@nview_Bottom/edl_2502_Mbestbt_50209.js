// 애즈명 : edl_2502_Mbestbt_50209
// 광고코드 :
// <script src="https://api.ootoo.co.kr/cou/api_reco.php?code=1ncom320x200&adid=&type=js&click_log=&click_type="></script>
; (function () {
    var adWidth = 320;
    var adHeight = 200;
    ...
    ; (function () {
        document.write('<script src="https://api.ootoo.co.kr/cou/api_reco.php?code=1ncom320x200&adid=' + _adid + '&type=js&click_log=&click_type="></script>');
    })()
})()