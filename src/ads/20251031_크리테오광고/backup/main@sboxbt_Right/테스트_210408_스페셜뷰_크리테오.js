(function () {
    ...
    var $ad_container = document.querySelector('.area_shopping_today');
    var $ad_id = 'criteo-1589785';
        ...
        if (bool) {
            ...
            try {
                Criteo.Passback.RenderAd($ad_id, function (adunit) {
                    ...
                    script.type = 'text/javascript';
                    script.async = true;
                    script.src = CyadLib.prefixUrl('https://cyad1.nate.com/js.kti/native/cri@sboxbt_Right');
