        ...
        if (bool) {
            ...
            function renderCriteo(json) {
                ...
                var _css = `
                    ...
                    #weekly-criteo-area .criteo-item-img {float:left;width:100px;margin-right:10px;font-size:0;text-align:center;overflow:hidden;}
                    #weekly-criteo-area .criteo-item-text {float:left;width:calc(100% - 110px);}
                    #weekly-criteo-area .criteo-item-text-title {display:block;display:-webkit-box;overflow:hidden;text-overflow:ellipsis;-webkit-line-clamp:2;-webkit-box-orient:vertical;word-wrap:break-word;line-height:1.2em;height:2.4em;font-size:14px;color:#333;}
                    #weekly-criteo-area .criteo-item-text-price {display:block;margin:12px 0;min-height:22px;font-size:15px;color:#ae0000;}
