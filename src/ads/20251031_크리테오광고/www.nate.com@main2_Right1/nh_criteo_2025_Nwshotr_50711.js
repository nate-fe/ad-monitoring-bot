    ...
    var getAds = function (bool) {
        if (bool) {
            ...
            function renderCriteo(json) {
                ...
                var _css = '#weekly-criteo-area a:hover {text-decoration:none;} #weekly-criteo-area {height:192px; box-sizing:border-box; padding:26px 16px; border:1px solid #e2e2e2;}#weekly-criteo-area .criteo-item-img-wrap {height:100%; display:flex; align-items:center; overflow:hidden; position:relative;} #weekly-criteo-area .criteo-item-img-wrap a {display:block;}#weekly-criteo-area .criteo-item-link {overflow:hidden;}#weekly-criteo-area .criteo-item-img {float:left;width:100px;height:100px;margin-right:10px;font-size:0;text-align:center;overflow:hidden;}#weekly-criteo-area .criteo-item-text {float:left;width:calc(100% - 110px);}#weekly-criteo-area .criteo-item-text-title {display:block;display:-webkit-box;overflow:hidden;text-overflow:ellipsis;-webkit-line-clamp:2;-webkit-box-orient:vertical;word-wrap:break-word;line-height:1.2em;max-height:2.4em;font-size:14px;color:#333;}#weekly-criteo-area .criteo-item-text-price {display:block;margin-top:3px;font-size:14px;color:#ae0000;}#weekly-criteo-area .criteo-item-btn-wrap {position:absolute;left:110px;bottom:19px;}#weekly-criteo-area .criteo-item-text-domain {font-size:13px;color:#a3a3a3;}#weekly-criteo-area .criteo-item-btn {font-size:12px; color:#118eff; display:block; margin-top:5px;}',
