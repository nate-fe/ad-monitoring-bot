...
try{
  var img_path  = CyadLib.prefixUrl('https://adimg.nate.com/img/2026/03/test/test_ondeal_0330_620x892.jpg');	//이미지 소재 경로 
  ...
  <img src="'+img_path+'" width="620" height="892" border="0" alt="광고"></a>';
