;(function () {
    ...
    ;(function(){
        ...
        var ifr_main_banner = document.getElementById('ifr_main_banner');
        _script.src = 'https://api.ad4989.or.kr/cou/ad_loader.php?afid=AF0700373&code=natem300x250';
        ifr_main_banner.appendChild(_script);
    })()
  })()