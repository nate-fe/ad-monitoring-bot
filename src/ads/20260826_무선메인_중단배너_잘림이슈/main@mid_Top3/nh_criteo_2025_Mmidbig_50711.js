...
(function setAdMidHeight(h) {
    h = h || 200;
    try {
        var win = window, fe;
        for (var i = 0; i < 5 && win !== win.parent; i++) {
            fe = win.frameElement;
            if (fe && fe.getAttribute('name') === 'ad_mid') {
                // iframe에 높이 지정
