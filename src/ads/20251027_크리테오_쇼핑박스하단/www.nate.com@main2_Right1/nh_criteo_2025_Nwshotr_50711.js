        ...
        $script.onload = function () {
            ...
            function renderCriteo(json) {
                ...
                for (var i in json.products) {
                    ...
                    htmlcode += '<img src="' + json.products[i].image.url + '" style="max-width:100%;max-height:100%;vertical-align:middle;" alt="��ǰ ���� �̹���" />';
                    htmlcode += '</span>';
                    htmlcode += '<span>';
            ...
            Criteo.events.push(function () {
                ...
                Criteo.Passback.RequestBids(adUnits, 1500, function (response) {
                    console.log(response);
                    if (response && response.slots && response.slots[$ad_id]) {
                        renderCriteo(response.slots[$ad_id]);
                    }
                }, 1500);
                ...
                Criteo.RequestBids(adUnits, function (response) {
                    ...
                    if (!response || !response.slots || response.slots.length === 0) {
                        ...
                        document.getElementById($ad_id).innerHTML = '<div>광고를 표시할 수 없습니다.</div>';
                        return;
                    }
            ...
            Criteo.events.push(function () {
                Criteo.Passback.RenderAd($ad_id, function (adunit) {
                    ...
                    if (div) {
                        ...
                        script.type = 'text/javascript';
                        script.async = true;
                        script.src = 'https://cyad1.nate.com/js.kti/nate/cri@main2_Right1';
                        div.appendChild(script);
                        $ad_container.appendChild(div);
                    }
                });
            });
        }
