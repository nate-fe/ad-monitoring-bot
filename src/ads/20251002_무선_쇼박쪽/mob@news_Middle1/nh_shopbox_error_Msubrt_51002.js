(function () {
    var _adHeight = 250;
    var $ad_view = document.getElementById('ifr_main_banner');
    if ($ad_view) {
        var _css = '#ifr_main_banner{height:auto;text-align:center;}.ad_inner_view_showpingbox{position:absolute;top:0;left:0;width:28px;height:18px;border:1px solid rgba(255,255,255,0.2);background:rgba(0,0,0,0.5);font-size:12px;font-weight:500;color:#fff !important;line-height:18px !important;z-index:1;}',
        ...
        _adBox.innerHTML = 'AD';
        _adBox.setAttribute('class', 'ad_inner_view_showpingbox');
