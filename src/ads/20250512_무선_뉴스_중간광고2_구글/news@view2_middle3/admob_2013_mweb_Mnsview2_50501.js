(function () {
    ...
    if ($ad_view) {
        var _css = 'div.news_view div.view_cont #ad_innerView2 {margin:0 auto;} #ad_innerView2{width:320px;height:auto;text-align:center;position:relative; margin:0 auto;}.ad_inner_view_box2{position:absolute;top:0;left:0px;width:28px;height:18px;border:1px solid rgba(255,255,255,0.2);background:rgba(0,0,0,0.5);font-size:12px;font-weight:500;color:#fff !important;line-height:18px !important;z-index:1;}#ad_innerView2 ins.adsbygoogle[data-ad-status="unfilled"] {display:block !important}',
        ...
        google_language = 'ko';
        google_safe = 'high';
        google_alternate_ad_url = location.protocol + '//cyad1.nate.com/html.kti/mnate/google@house_x14';
