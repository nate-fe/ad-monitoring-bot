(function() {
    ...
    if($ad_view) {
      ...
      _css = '.news_view .view_cont #ad_innerView {width:300px; margin:30px auto 50px; position:relative;} .ad_inner_view_box {position:absolute; top:0; left:0; width:28px; height:18px;border:1px solid rgba(255,255,255,0.2);background:rgba(0,0,0,0.5);font-size:12px;font-weight:500;color:#fff !important;line-height:18px !important;z-index:1; text-align:center;} #ad_innerView iframe {height:250px;}';
      ...
      _iframe.setAttribute('src', '//awesomeclick.co.kr/adSb/?k=MTcx&pb=&di=&kwd=');
