...
var img_path  = CyadLib.prefixUrl('https://adimg.nate.com/img/2026/04/cbc/cbc_p16_200x600.jpg');	//이미지 소재 경로
var nate_subMarginCube = {};
nate_subMarginCube.ua = navigator.userAgent.toLowerCase();
nate_subMarginCube.adDivOrgIdR = 'ad_newsMarginCube_right';
...
nate_subMarginCube.Init = function () {
    ...
    try {
        var ad_div = parent.document.getElementById(nate_subMarginCube.adDivOrgIdR);
        ad_div.innerHTML = el;
    } catch(e) {
