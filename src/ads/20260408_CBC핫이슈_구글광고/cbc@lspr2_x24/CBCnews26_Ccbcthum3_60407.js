...
var _adArea = 'cbcArea3';
_div.setAttribute('id', _adArea);
_div.style.marginBottom = '8px';
var _currentScript = document.currentScript;
var _parent = _currentScript.closest('#ad_newsMarginCube_right');
_parent.appendChild(_div);

var img_path  = CyadLib.prefixUrl('https://adimg.nate.com/img/2026/04/cbc/cbc_p12_200x150.jpg');	//이미지 소재 경로
var nate_subMarginCube = {};
nate_subMarginCube.ua = navigator.userAgent.toLowerCase();
nate_subMarginCube.adDivOrgIdL = _adArea;
...
nate_subMarginCube.Init = function () {
    ...
    try {
        var ad_div = parent.document.getElementById(_adArea);
        ad_div.innerHTML = el;
    } catch(e) {
