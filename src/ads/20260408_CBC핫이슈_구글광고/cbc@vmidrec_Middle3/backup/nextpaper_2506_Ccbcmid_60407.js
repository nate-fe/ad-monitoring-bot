...
try{
  var img_path  = CyadLib.prefixUrl('https://adimg.nate.com/img/2026/04/cbc/cbc_p17_300x250.jpg');	//이미지 소재 경로 
  ...
  <img src="'+img_path+'" width="300" height="250" border="0" alt="광고"></a>';
