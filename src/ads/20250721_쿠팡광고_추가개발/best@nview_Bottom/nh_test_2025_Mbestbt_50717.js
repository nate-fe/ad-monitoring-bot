; (function () {
    ...
    // top level iframe
    try {
        parent.document.getElementById('ad_big2').height = 250;
        parent.document.getElementById('ad_big2').style.height = '250px';
        if (__parent) {
    ...
    ; (function () {
        document.write('<script src="https://api.ootoo.co.kr/cou/api_reco.php?code=am300x250natem&adid=&type=js&click_log=&click_type="></script>');
    })()
})()