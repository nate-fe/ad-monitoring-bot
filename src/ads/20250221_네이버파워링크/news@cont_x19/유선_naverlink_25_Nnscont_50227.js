window.onload = function(){
    ...
    var _css = `
        ...
        .naver_power_link {background-color:#F9F9F9; padding:16px 16px;} 
        .naver_power_link .ad_comp {min-height:76px; margin-bottom:14px; }
        .naver_power_link .ad_comp:last-child {margin-bottom:0;}
        .naver_power_link .display_url {display:block; width:100%; overflow:hidden; text-overflow:ellipsis; white-space: nowrap; font-weight:500; line-height:18px; margin-bottom:6px;}
        ...
        .naver_power_link .display_url .url {display:inline-block; vertical-align:0px; color:#949494; font-size:12px; padding-left:4px; letter-spacing:-0.5px; line-height:18px;}
        .naver_power_link .tit_area {margin-bottom:5px;}
        ...
        .naver_power_link .desc_area, .naver_power_link .desc_area a {font-size:12px; line-height:22px; letter-spacing:-0.4px; color:#000; color:#333;} 
        .naver_power_link .ad_comp.contains_img {padding-left:115px; position:relative;}
        .naver_power_link .img_area {border:1px solid #ddd; position:absolute; left:0; top:0; width:100px; height:76px; overflow:hidden; border-radius:10px;}
        .naver_power_link .img_area img {width:100%; } 
        .naver_power_link .tag_area {overflow:hidden;} 
        .naver_power_link .tag_area .tag {display:inline-block; margin-right:5px; -webkit-tap-highlight-color: rgba(0, 0, 0, .1); color:#777; background-color:#fff; border: 1px solid #e9e9ec; font-size: 11px; padding: 7px 14px; border-radius: 30px; }
    `,
    ...
    // 네이트_공통
    var keywordGroup = '%EB%84%A4%EC%9D%B4%ED%8A%B8_%EA%B3%B5%ED%86%B5'
    ...
    function loadData() {
        httpRequest(endpoint + '/api/v2/ads/search?channel=nate.ch1&pageSize='+ pageSize +'&pageNo=1&query=&url='+ url +'&userAgent='+ userAgent +'&keywordGroup='+ keywordGroup, function(data) {
            var ads = data.ads;
            ...
            _body.appendChild(_naverPowerLink)
        })
    }
    loadData();
} catch(e) {} 
